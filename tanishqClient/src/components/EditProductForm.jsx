...
import { updateProducts } from "../store/product/action";

const EditProductForm = (OneProduct) => {
  const Obj = OneProduct.OneProduct[0]
  ...
  const [product, setProduct] = useState({
        ...
        jewellery_type:Obj.jewellery_type,
        purity:Obj.purity,
        metal:Obj.metal._id,
        gender:Obj.gender._id,
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(updateProducts({values: formData, ID:Obj._id})); 
